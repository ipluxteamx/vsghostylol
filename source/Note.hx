...
class Note extends FlxSkewedSprite
{
	...
	//	trace("Type == " + type);
		if (type == 1) { //????
			...
			frames = Paths.getSparrowAtlas('notes/NOTE_flip');
			animation.addByPrefix('greenScroll', 'green alone', 30, false);
			animation.addByPrefix('redScroll', 'red alone', 30, false);
			animation.addByPrefix('blueScroll', 'blue alone', 30, false);
			animation.addByPrefix('purpleScroll', 'purple alone', 30, false);
			setGraphicSize(Std.int(width * 0.6));
			updateHitbox();
			antialiasing = true;
			//animation.play('redScroll', true);
