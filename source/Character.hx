...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ghosty':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('modChars/ghosty');
				frames = tex;
				...
				addOffset('idle', 8, -190);
				addOffset("singUP", -16, -140);
				addOffset("singRIGHT", -60, -193);
				addOffset("singLEFT", 32, -193);
			...
			case 'madghosty':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('modChars/madghosty');
				frames = tex;
				animation.addByPrefix('idle', 'idle', 24);
				animation.addByPrefix('singUP', 'up', 24);
				animation.addByPrefix('singRIGHT', 'right', 24);
