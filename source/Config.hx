...
class Config extends MusicBeatState
{
	...
	**/
	 ...
	 */
	 public static var TITLEMESSAGE:Array<String> = ["Friday Night Funkin", "VS", "Ghosty"];
	 ...
	 * Default = **ProjectFNF**
	 */
	public static var ModName:String = 'V.S. Ghosty';
	 ...
	 * Default = **0.002**
	 */
	public static var MISSINTENSITY = 0.005;

	/**
		*uh
	**/
	public static var CacheSongs = true;
}
