...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		{
			logoBl.frames = Paths.getSparrowAtlas('ghostyLogoBumpin');
			logoBl.x += 200;
			logoBl.y += 30;
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 2:
				addMoreText('iplux');
			case 3:
				addMoreText('Themomentwhen');
			case 4:
				addMoreText('ZachEP');
			case 5:
				addMoreText('Jlithr33');
			case 6:
				deleteCoolText();
			case 7:
				createCoolText(['da portraits', 'by']);
				//ngSpr.visible = true;
			// credTextShit.text += '\nNewgrounds';
			case 8:
				addMoreText('Cval and Rozebud');
			case 9:
				deleteCoolText();
			//	ngSpr.visible = false;
			// credTextShit.visible = false;
